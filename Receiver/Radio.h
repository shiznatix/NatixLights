...
class Radio {
	public:
		...
		void sendHealthMessage(char status);
	...
	private:
		...
		const unsigned int SEND_HEALTH_DELAY = 1000;// milliseconds
		unsigned long mReceiveTimer = 0;
		unsigned long mRadioSendHealthTimer = 0;
};
